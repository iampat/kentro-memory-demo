"""kentro-server API Pydantic v2 types — manually mirrored from `kentro.types`.

Parity is enforced by `tests/unit/types_parity_test.py`. To intentionally diverge
(e.g., MCP-facing string statuses), update the test to allow the specific divergence
in the same change.
"""
